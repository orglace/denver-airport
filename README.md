...
1. Clone the github repository to the local machine (or you could download from https://github.com/orglace/denver-airport/archive/master.zip). So open a terminal en your computer and type:
