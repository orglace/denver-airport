...
1. Clone the github repository to the local machine (or download it from https://github.com/orglace/denver-airport/archive/master.zip). So open up a computer terminal and type:
